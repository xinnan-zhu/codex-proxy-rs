...
pub(crate) async fn load_admin_account_page(
    ...
    let statement = format!(
        "with account_statuses as (
         ...
         select p.location_country, p.location_region, p.location_city, p.location_timezone, a.outbound_proxy_url, a.id, a.provider_kind, a.name, a.notes, a.codex_only, a.email, a.upstream_user_id,
